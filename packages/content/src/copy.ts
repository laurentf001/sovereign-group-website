export const sovereignCapitalCopy = {
  ...
  whoWeAre: {
    ...
    marketContext:
      "South Africa's over-60 population stands at 5.4 million today and is projected to reach 12 million by 2050. Only 2% of seniors currently reside in formal housing. The structural gap is vast, the timing is now, and the patient capital we deploy is ideally suited to capture it.",
  },
  businessUnits: {
    label: "THE GROUP",
  ...
  about: {
    ...
    geography: {
      label: "GEOGRAPHY",
      headline: "Western Cape rooted. Indian Ocean reaching.",
      regions: [
        {
          name: "South Africa",
...
export const retirement247Copy = {
  ...
  whyLifeRights: {
    ...
    returnStats: [
      {
        value: "~20%",
        label: "Return on cost, first-round sales (greenfield)",
      },
      {
        value: "8–10%",
        label: "Annual unit churn from Year 5 (recurring income)",
      },
      { value: "100%", label: "Resale profit retained by asset owner" },
      {
        value: "3%",
        label: "Effective tax rate on life right income (Brummeria)",
      },
    ],
    assetOwnerBullets: [
  ...
  services: {
    label: "SERVICES",
    headline: "End-to-end support. From concept to exit.",
  },
  whoWeServe: {
    label: "WHO WE SERVE",
