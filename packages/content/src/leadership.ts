...
export const sovereignCapitalLeadership: Leader[] = [
  {
    name: "Lauren Peacock",
    title: "Executive Director · Sovereign Capital",
    initials: "LP",
    bio: "Executive Director of Sovereign Capital, responsible for group governance, strategic partnerships, and operational leadership across the Sovereign consortium. Lauren brings rigorous institutional discipline to a group operating across multiple complex, long-duration development mandates simultaneously.",
  },
  {
    name: "Rhys Meredith",
    title: "Executive Director · Sovereign Capital",
    initials: "RM",
    bio: "Executive Director of Sovereign Capital, contributing senior leadership across the group's capital structuring, development partnerships, and institutional relationships. Rhys brings depth of experience to a consortium operating at the intersection of property development, structured finance, and long-duration asset management.",
  },
  {
    name: "Arthur Case",
    title: "Chief Executive Officer · Sovereign Senior Living",
    initials: "AC",
